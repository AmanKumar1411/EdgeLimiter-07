    ...
    >
      <div className="panel-head">
        <div>
          ...
          <p>
            Onboard a new company, generate API key,
            and create client access.
          </p>
        </div>
      ...
      >
        ...
        <Field
          label="Tenant ID"
          hint="Company / tenant identifier"
        >
          <input
            className="input"
            value={tenantId}
      ...
      {status === "success" ? (
        <div className="notice notice-success">
          Client successfully onboarded. API key is
          ready to use.
        </div>
      ) : null}
    </section>
